...
echo driverless | sudo -S ip link set can0 up type can bitrate 1000000 restart-ms 100 berr-reporting on
#fd on
echo driverless | sudo -S ifconfig can0 txqueuelen 1000
#cangen -v can0 -g 400
