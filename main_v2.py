...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            [throttle, brake, steer, clutch, upgear, downgear], data = agent.get_action(detections, y_hat, speed, gear, rpm)
            ...
            if verbose==1:
                ...
                visualizer.visualize([image, detections, cenital_map, y_hat, speed], [throttle, brake, steer, clutch, upgear, downgear, gear, rpm], fps, save_frames=True)
