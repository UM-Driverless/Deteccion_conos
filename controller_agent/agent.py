...
from trayectory_estimation.cone_processing import ConeProcessing, ConeProcessingNoWrapped
import cv2
import simple_pid
import numpy as np
...
class AgentAccelerationYoloFast(AgentAcceleration):
    ...
    def getCones(self):
        return self.actual_cones_can, self.total_cones_can
