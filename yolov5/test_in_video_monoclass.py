...
capture = cv2.VideoCapture('/media/archivos/UMotorsport/video_21_11_21_16_59_1.avi')
model = torch.hub.load('.', 'custom', path='weights/yolov5s-cones-fine/weights/best.pt', source='local', force_reload=True)
